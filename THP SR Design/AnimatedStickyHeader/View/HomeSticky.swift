    ...
    func ArtWork() -> some View {
        ...
        GeometryReader { proxy in
            ...
            Image("nature")
                ...
                .frame(width: size.width, height: size.height + (minY > 0 ? minY : 0)) // drag to zoom
                .clipped()
                .overlay(content: {
...
struct HomeSticky_Previews: PreviewProvider {
